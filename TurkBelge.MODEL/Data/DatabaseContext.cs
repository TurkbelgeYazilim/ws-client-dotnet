...
namespace TurkBelge.MODEL.Data
{
    public class DatabaseContext : DbContext
    {
        ...
        public DatabaseContext() :
            ...
            {
                ConnectionString = new SQLiteConnectionStringBuilder() { DataSource = projectDirectory + @"\TurkBelge.MODEL\Db\TurkBelge-Entegrasyon.s3db", ForeignKeys = true }.ConnectionString
            }, true)
        {
        }
